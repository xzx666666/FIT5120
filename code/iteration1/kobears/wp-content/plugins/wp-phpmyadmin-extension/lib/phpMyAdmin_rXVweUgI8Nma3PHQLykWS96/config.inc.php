...
$cfg['blowfish_secret']					= 'RY2@j5ep\'D[GhqW\"]ne;7xgA]>4e\\)q\'' ;  // i.e. '$b~`lnkwm>^^jNUEE;(4xB$L\'b?."\'o9' 
...
$cfg['PmaAbsoluteUri'] 					= 'https://www.kkobears.com/wp-content/plugins/wp-phpmyadmin-extension/lib/phpMyAdmin_rXVweUgI8Nma3PHQLykWS96/';			//used, if different directory by htaccess ; or parse_url($GLOBALS['PMA_PHP_SELF']);
